...
import { MOCK_Analysis, MARKET_ANALYSIS, INSIGHTS, ANALYTICAL_PERFORMANCE } from './data';

/**
 * Ahsan Raza - Technical Analyst Portfolio
 * Design: Institutional Research Terminal / Quantitative Research Platform
 */

// --- Sub-components ---
const socialLinks = [
  { icon: Twitter, link: "https://x.com/vfsintelligence" },
  { icon: Instagram, link: "https://instagram.com/vfsintelligence" },
  // { icon: Globe, link: "https://yourwebsite.com" },
];
...
const ExecutionLog = () => {
  const [filter, setFilter] = useState<{ asset: string | null; result: string | null }>({ asset: null, result: null });
  
  const filteredAnalysis = useMemo(() => {
    return MOCK_Analysis.filter(t => {
